...
procedure TEditContactForm.TranslateForm;
begin
...
procedure TEditContactForm.FormDblClick(Sender: TObject);
begin
...
procedure TEditContactForm.OKButtonClick(Sender: TObject);
{ label
  x;
  var
  i, ii: integer; }
...
procedure TEditContactForm.FormCreate(Sender: TObject);
begin
