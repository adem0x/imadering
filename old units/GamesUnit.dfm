object GamesForm: TGamesForm
  ...
  object GamesClient: THttpCli
    ...
    Options = []
    OnSessionClosed = GamesClientSessionClosed
    OnDocBegin = GamesClientDocBegin
    OnDocData = GamesClientDocData
    OnRequestDone = GamesClientRequestDone
    OnCookie = GamesClientCookie
    SocksAuthentication = socksNoAuthentication
    OnSocksConnected = GamesClientSocksConnected
    OnSocksError = GamesClientSocksError
    Left = 48
    Top = 32
  end
end
