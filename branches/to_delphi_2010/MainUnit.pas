...
type
  TMainForm = class(TForm)
    ...
    HidexTrayMenu: TMenuItem;
    ClosexTrayMenu: TMenuItem;
    N24: TMenuItem;
    ...
    procedure HidexTrayMenuClick(Sender: TObject);
...
procedure TMainForm.HidexTrayMenuClick(Sender: TObject);
begin
  ...
  begin
    ...
    begin
      ProfileForm.Hide;
      HidexTrayMenu.Caption := RestoreFromTrayStr;
      HidexTrayMenu.ImageIndex := 5;
    end
    else
    begin
      XShowForm(ProfileForm);
      HidexTrayMenu.Caption := HideInTrayStr;
      HidexTrayMenu.ImageIndex := 4;
    end;
  end;
end;
...
begin
  ...
  // Отображаем окно выбора профиля
  XShowForm(ProfileForm);
