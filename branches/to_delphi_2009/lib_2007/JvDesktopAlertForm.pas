...
-------------------------------------------------------------------------------}
// $Id: JvDesktopAlertForm.pas 11413 2007-07-11 20:23:46Z ahuser $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net/svnroot/jvcl/branches/JVCL3_33_PREPARATION/run/JvDesktopAlertForm.pas $';
...
uses
  Menus, SysUtils, JvJVCLUtils, JvDesktopAlert, JvResources, MainUnit, VarsUnit,
  ChatUnit;
...
begin
  ...
  lblHeader.Left := imIcon.Left + imIcon.Width + 4;
  lblHeader.Width := tbClose.Left - 15;
  lblText.Left := 8; //lblHeader.Left + 8;
  //lblText.Width := tbDropDown.Left - lblText.Left;
  lblText.Width := tbClose.Left + 2;
  lblText.Top := lblHeader.Top + lblHeader.Height + 6;
  lblText.Height := Height - 35;
end;
