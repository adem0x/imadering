  ...
  begin
    ...
    begin
      ...
      begin
        ...
        if not MainForm.JvTimerList.Events[11].Enabled then
        begin
        ...
        begin
          ...
          begin
            ...
            if CLItem.ImageIndex <> 165 then CLItem.ImageIndex := 165
            else CLItem.ImageIndex := StrToInt(Items[i].SubItems[6]);
          ...
          if ChatItem <> nil then
          begin
            if ChatItem.ImageIndex <> 165 then ChatItem.ImageIndex := 165
            else ChatItem.ImageIndex := StrToInt(Items[i].SubItems[6]);
