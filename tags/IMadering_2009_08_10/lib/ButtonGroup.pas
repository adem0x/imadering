...
uses
  ...
  Graphics, StdCtrls, CategoryButtons;
...
type
  ...
  public
    constructor Create(const ButtonGroup: TButtonGroup);
...
uses Themes, GraphUtil, ExtCtrls, Types;
...
begin
  ...
  begin
    ...
    EdgeColor := clWhite; //GetShadowColor(FillColor, -45);
    Canvas.FillRect(Rect);
  ...
  Canvas.Brush.Color := clWhite; //Color; { Restore the original color }
end;
