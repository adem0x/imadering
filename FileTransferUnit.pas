          ...
          case SendFileClient.Tag of // Определяем выполнение задания для данных по флагу
            0:
              begin
                ...
                Xlog(SendFileClient.Name + C_BN + Log_Parsing, Skey, C_HTTP);
                ...
                begin
                  ...
                  Xlog(SendFileClient.Name + C_BN + Log_Parsing, URL, C_HTTP);
            ...
            1:
              begin
                ...
                begin
                  ...
                  Xlog(SendFileClient.Name + C_BN + Log_Parsing, OKURL, C_HTTP);
                  case Tag of
                  ...
                  begin
                    ...
                    HistoryFile := V_ProfilePath + C_HistoryFolder + C_Icq + C_BN + ICQ_LoginUIN + C_BN + T_UIN + C_Htm_Ext;
                  end
                  ...
                  begin
                    ...
                    // Формируем файл с историей
                    HistoryFile := V_ProfilePath + C_HistoryFolder + C_Jabber + C_BN + Jabber_LoginUIN + C_BN + T_UIN + C_Htm_Ext;
                  end
                  ...
                  begin
                    ...
                    // Формируем файл с историей
                    HistoryFile := V_ProfilePath + C_HistoryFolder + C_Mra + C_BN + MRA_LoginUIN + C_BN + T_UIN + C_Htm_Ext;
                  end
                  else
                    goto X;
                ...
                begin
                  BottomInfoPanel.Caption := Lang_Vars[17].L_S + C_TN + C_BN + C_UpWap_BadFileFormat;
                  DAShow(Lang_Vars[17].L_S + C_BN + SendFileClient.Name, C_UpWap_BadFileFormat, EmptyStr, 134, 2, 0);
                end;
                X: ;
