object RosterForm: TRosterForm
  ...
  object RosterJvListView: TJvListView
    ...
    Columns = <
      ...
      item
        Caption = #1053#1072#1073#1080#1088#1072#1077#1090' '#1089#1086#1086#1073#1097#1077#1085#1080#1077
      end
      item
        Caption = #1042#1088#1077#1084#1103' '#1085#1072#1073#1086#1088#1072
      end>
    ColumnClick = False
    GridLines = True
    HideSelection = False
