  ...
  type
    ...
    TLogger = class(TInterfacedObject, ILogger)
      ...
      public
        ...
        ///<summary>Выставляет неодходимый кровень логирования</summary>
...
begin
  ...
  if (DaysBetween(Now, Date) >= 1) then begin
    LogFile.Clear;
  ...
  try
    try
      if LogFile = nil then begin
        ...
        if FileExists(FFullLogPath) then begin
...
finalization
  ...
  //TLogger(TLogger.Instance).Destroy;
